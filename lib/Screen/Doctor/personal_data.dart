...
class _DoctorPersonalDataState extends State<DoctorPersonalData> {
  ...
  void initState() {
    super.initState();
    _doctName.text = widget.doctName.isNotEmpty ? widget.doctName : "";
  ...
  final TextEditingController _doctName = TextEditingController();
